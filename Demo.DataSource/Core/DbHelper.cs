...
using Demo.Data.Config;
using Demo.Data.Core.EntityTool;
using Demo.Data.Core.EntityTool.DelegateReflection;
using Demo.Data.DataBaseMap;
using Demo.Data.SQL;
...
namespace Demo.Data.Core
{
    ...
    public class DbHelper
    {
        ...
        {
            var result = new T();
            var dynamicSet = new ExpressionReflection<T>();
        ...
        private static IEnumerable<T> ReadDatas<T>(DbDataReader reader) where T : class, new()
        {
            ...
            var dynamicGet = new ExpressionReflection<T>();
